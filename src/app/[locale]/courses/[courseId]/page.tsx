...
const COURSE_DATA: Record<string, {
  ...
  "c5000000-0000-0000-0000-000000000001": {
    title: "日本生活スキルコース",
    description: "日本で安心して生活するための実践的なスキルを習得。住居・銀行・病院・交通・役所手続きなど、外国人が日本生活で直面するあらゆる場面に対応できる力を身につけます。",
    category: "生活スキル",
    emoji: "🏡",
    ...
    learners: 876,
    rating: 4.8,
    targetLevel: "N5〜N3レベル（生活場面特化）",
    whatYouLearn: [
      "住居探し・契約・近隣挨拶など住まいに関する語彙と表現",
      "銀行口座開設・ATM・送金・公共料金支払いの実践語彙",
      "病院受診・保険証・薬局でのやり取りに使う表現",
      "電車・バス・タクシーの乗り方と交通に関する語彙",
      "役所手続き・在留資格・税金など行政手続きの語彙",
      "緊急時・災害時の対応と110番・119番の使い方",
    ],
    lessons: [
      { id: "l5000000-0000-0000-0000-000000000001", title: "第1課: 住居・住まい", subtitle: "家賃・敷金・礼金・管理費・近隣挨拶など15語", type: "vocabulary", duration: 30, wordCount: 15, isCompleted: false, isLocked: false },
      { id: "l5000000-0000-0000-0000-000000000002", title: "第2課: 銀行・お金・支払い", subtitle: "口座・振込・引き落とし・ATM・公共料金など15語", type: "vocabulary", duration: 30, wordCount: 15, isCompleted: false, isLocked: false },
      { id: "l5000000-0000-0000-0000-000000000003", title: "第3課: 病院・医療・薬局", subtitle: "受診・保険証・処方箋・薬局・健康診断など15語", type: "vocabulary", duration: 35, wordCount: 15, isCompleted: false, isLocked: false },
      { id: "l5000000-0000-0000-0000-000000000004", title: "第4課: 交通・移動・地図", subtitle: "乗り換え・定期券・時刻表・道案内・タクシーなど15語", type: "vocabulary", duration: 30, wordCount: 15, isCompleted: false, isLocked: false },
      { id: "l5000000-0000-0000-0000-000000000005", title: "第5課: 役所・手続き・緊急時", subtitle: "在留資格・転入届・マイナンバー・119番・避難など15語", type: "vocabulary", duration: 35, wordCount: 15, isCompleted: false, isLocked: false },
      { id: "l5000000-0000-0000-0000-000000000006", title: "文法1: 〜てもいいですか・〜てはいけません", subtitle: "許可を求める・禁止を伝える生活場面の表現", type: "grammar", duration: 30, isCompleted: false, isLocked: false },
      { id: "l5000000-0000-0000-0000-000000000007", title: "文法2: 〜に〜があります・〜はどこですか", subtitle: "場所を尋ねる・説明する・道案内の表現", type: "grammar", duration: 30, isCompleted: false, isLocked: false },
      { id: "l5000000-0000-0000-0000-000000000008", title: "文法3: 〜たいんですが・〜をお願いします", subtitle: "窓口・電話で要件を伝える丁寧な依頼表現", type: "grammar", duration: 35, isCompleted: false, isLocked: false },
      { id: "l5000000-0000-0000-0000-000000000009", title: "文法4: 〜場合は・〜とき・〜なら", subtitle: "条件・緊急時の対応を説明する表現", type: "grammar", duration: 35, isCompleted: false, isLocked: false },
      { id: "l5000000-0000-0000-0000-000000000010", title: "確認テスト①: 住居・銀行・支払い（10問）", subtitle: "住まいとお金の語彙チェック", type: "quiz", duration: 15, questionCount: 10, isCompleted: false, isLocked: false },
      { id: "l5000000-0000-0000-0000-000000000011", title: "確認テスト②: 病院・交通（10問）", subtitle: "医療と移動の語彙チェック", type: "quiz", duration: 15, questionCount: 10, isCompleted: false, isLocked: false },
      { id: "l5000000-0000-0000-0000-000000000012", title: "確認テスト③: 役所・文法総合（10問）", subtitle: "行政手続きと生活文法チェック", type: "quiz", duration: 15, questionCount: 10, isCompleted: false, isLocked: false },
      { id: "l5000000-0000-0000-0000-000000000013", title: "確認テスト④: 生活スキル総合まとめ（10問）", subtitle: "日本生活スキル全範囲の総合チェック", type: "quiz", duration: 20, questionCount: 10, isCompleted: false, isLocked: false },
    ],
  },
};

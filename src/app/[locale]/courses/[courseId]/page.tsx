...
const COURSE_DATA: Record<string, {
  ...
  "c2000000-0000-0000-0000-000000000001": {
    title: "介護の日本語 基礎コース",
    description: "介護現場で実際に使う日本語。申し送り・記録・利用者対応まで実践的に学びます。",
    category: "介護専門",
    emoji: "🏥",
    ...
    lessons: [
      { id: "l2000000-0000-0000-0000-000000000001", title: "第1課: 介護現場の基本語彙", subtitle: "施設・職種・道具の名称20語", type: "vocabulary", duration: 25, wordCount: 20, isCompleted: false, isLocked: false },
      { id: "l2000000-0000-0000-0000-000000000002", title: "第2課: 申し送りの書き方", subtitle: "記録フォーマットと必須表現", type: "grammar", duration: 30, isCompleted: false, isLocked: false },
      { id: "l2000000-0000-0000-0000-000000000003", title: "第3課: 食事介助の声かけ", subtitle: "食事・水分摂取の確認表現", type: "vocabulary", duration: 20, wordCount: 15, isCompleted: false, isLocked: false },
      { id: "l2000000-0000-0000-0000-000000000004", title: "確認テスト: 第1〜3課", subtitle: "介護基礎語彙の理解度チェック", type: "quiz", duration: 15, questionCount: 10, isCompleted: false, isLocked: false },
    ],
  },
};
